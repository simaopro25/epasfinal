...
$table->setFieldsAtive("id, nome, telefone, email, TipoEscola, confirmada",'list');
$table->setFieldsAtive("nome, localizacao, pais, foto, telefone, email, TipoEscola, PaginaWeb, utilizador, confirmada, latitude, longitude", 'new');
$table->setFieldsAtive("nome, localizacao, pais, foto, telefone, email, TipoEscola, PaginaWeb, utilizador, confirmada, latitude, longitude", 'edit');
$table->setFieldsAtive("nome, localizacao, foto, telefone, email, TipoEscola, PaginaWeb, utilizador, confirmada, latitude, longitude", 'csv');
...
//Labels for fields
$table->setLabel('TipoEscola',"Tipo de Escola");
...
$table->setCriterio("confirmada=0");
