...
$table->setFieldsAtive("Imagem, Titulo, Texto, Data, local_evento, criador, ativacao", 'list');
$table->setFieldsAtive("Imagem, Titulo, Texto, Data, local_evento, CodigoCategoria, criador, ativacao", 'new');
$table->setFieldsAtive("Imagem, Titulo, Texto, Data, local_evento, CodigoCategoria, criador, ativacao", 'edit');
