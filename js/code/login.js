...
class login {
  ...
  //esconder os menus de acordo com o estilo de escola
  async GetId() {
    ...
    for (const v of lv) {
      if (v.user !== null) {
        document.getElementById("perfilid").setAttribute("href", "/public/perfil/"+ v.id);
        console.log(v.level)
        if(v.level=="escola"){
          console.log("ffff")
          document.getElementById("collapsePages").style.visibility = "hidden";
          document.getElementById("menuTabelas").style.visibility = "hidden";
          document.getElementById("validarEscolas").style.visibility = "hidden";
          document.getElementById("menuCarrossel").style.visibility = "hidden";
        }
